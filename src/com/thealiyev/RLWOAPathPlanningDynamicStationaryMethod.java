...
public class RLWOAPathPlanningDynamicStationaryMethod {
    private static Random random = null;

    public static void main(String[] args) {
        RLWOAPathPlanningDynamicStationaryMethod rlwoaPathPlanningDynamicStationaryMethod = new RLWOAPathPlanningDynamicStationaryMethod();
        rlwoaPathPlanningDynamicStationaryMethod.RLWOA();
    }

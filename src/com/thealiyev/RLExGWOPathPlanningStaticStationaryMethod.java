...
public class RLExGWOPathPlanningStaticStationaryMethod {
    private static Random random = null;

    public static void main(String[] args) {
        RLExGWOPathPlanningStaticStationaryMethod rlExGWOPathPlanningStaticStationaryMethod = new RLExGWOPathPlanningStaticStationaryMethod();
        rlExGWOPathPlanningStaticStationaryMethod.RLExGWO();
    }

...
public class RLWOAPathPlanningStaticStationaryMethod {
    private static Random random = null;

    public static void main(String[] args) {
        RLWOAPathPlanningStaticStationaryMethod rlwoaPathPlanningStaticStationaryMethod = new RLWOAPathPlanningStaticStationaryMethod();
        rlwoaPathPlanningStaticStationaryMethod.RLWOA();
    }

...
public class RLIGWOPathPlanningStaticStationaryMethod {
    private static Random random = null;

    public static void main(String[] args) {
        RLIGWOPathPlanningStaticStationaryMethod rligwoPathPlanningStaticStationaryMethod = new RLIGWOPathPlanningStaticStationaryMethod();
        rligwoPathPlanningStaticStationaryMethod.RLIGWO();
    }

...
public class RLIGWOPathPlanningDynamicStationaryMethod {
    private static Random random = null;

    public static void main(String[] args) {
        RLIGWOPathPlanningDynamicStationaryMethod rligwoPathPlanningDynamicStationaryMethod = new RLIGWOPathPlanningDynamicStationaryMethod();
        rligwoPathPlanningDynamicStationaryMethod.RLIGWO();
    }
